...
$count=\FMGlobal\Repositories\LinkCredentialMigration::apply(database(),new \FMGlobal\Services\Links\AccountVault());
echo $count." cuentas convertidas al separador de dos puntos.\n";
